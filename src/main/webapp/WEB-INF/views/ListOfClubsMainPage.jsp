    ...
    <div class="body">
        <div class="LeftDashBoard">
            ...
            <div class="club">
                <div class="subList">
                <c:if test="${type.equals('club')}">
					<p><a href="UsersRegisteredClubs">My Registered Clubs</a></p>
				</c:if>
				<c:if  test="${type.equals('event')}">
					<p><a href="UsersRegisteredEvents">My Registered Events</a></p>
				</c:if>
					    		...
					    		<c:forEach var="club" items="${clubs}">
						    		<div class="data">
							            ...
							            <div class="buttons">
							            	...
							            	<c:if  test="${type.equals('event')}">
							            	<a href="viewEventsOfClub/${club.clubid}">View Events</a>
							            	</c:if>
