...
function validate() {
	...
	<div class="body">
		<div class="img">
			<img
				src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/14/Humaaans-sitting-1.svg/380px-Humaaans-sitting-1.svg.png"
				alt="Sitting Lady">
		</div>
		<s:form name="myform" class="form" action="loginperson" onsubmit="return validate()"   method="post" modelAttribute="loginperson">
